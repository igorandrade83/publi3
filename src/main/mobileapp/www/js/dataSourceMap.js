...
window.dataSourceMap["app.testeMari"] = { customId: "app.entity.testeMari", serviceUrl: "api/cronapi/crud/app.entity.testeMari", serviceUrlODATA: "/api/cronapi/odata/v2/app/testeMari" };
